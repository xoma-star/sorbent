...
const AlsoUsage = () => {
    return (
        <div className={'flex flex-col mt-4 gap-8'}>
            <Title className={'lg:px-80 px-8 py-16'}>Области и способы применения сорбента ЭКОСОРБ</Title>
            <div className={'flex sm:flex-row flex-col-reverse items-center gap-12'}>
                <img height={'auto'} src={'https://ag-sorb.ru/img/application_1.jpg'} alt={'neft'} className={'sm:rounded-r-3xl w-full shrink-0 sm:w-[40%] mb-8 sm:mb-0'}/>
            ...
            <div className={'flex sm:flex-row flex-col items-center gap-12'}>
                ...
                <img height={'auto'} src={'https://ag-sorb.ru/img/application_2.jpg'} alt={'neft'} className={'sm:rounded-l-3xl w-full shrink-0 sm:w-[40%] mb-8 sm:mb-0'}/>
            </div>
            <div className={'flex sm:flex-row flex-col-reverse items-center gap-12'}>
                <img height={'auto'} src={'https://ag-sorb.ru/img/application_3.jpg'} alt={'neft'} className={'sm:rounded-r-3xl w-full shrink-0 sm:w-[40%] mb-8 sm:mb-0'}/>
                <div className={'sm:pr-16 px-4'}>
