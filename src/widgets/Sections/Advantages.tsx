...
const advantages = [
    ...
    {title: 'Экологичность', description: 'ЭКОСОРБ производится из натуральных материалов и не содержит вредных химических веществ, что делает его экологически безопасным.'},
    {title: 'Простота использования', description: 'ЭКОСОРБ очень прост в использовании и может применяться для устранения различных видов нефтяных загрязнений на любых поверхностях.'},
...
const Advantages = () => {
    return (
        <div className={'lg:px-80 px-12 py-16'} id={'advantages'}>
